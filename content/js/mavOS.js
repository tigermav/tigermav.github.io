...
gv_MyGame.mavOS.prototype = {
	...
	preload: function()
	{
      ...
      this.load.image('wallpaper', ('content/img/wallpaper.png') );
      this.load.image('bottomStrip', ('content/img/bottomStrip_opacity1.png') );
	  this.load.image('logo', ('content/img/logo.png') );
	  this.load.image('folder', ('content/img/folder.png') );
	  this.load.image('text_PuzzlesOfZack', ('content/img/text_PuzzlesOfZack.png') );
	  this.load.image('text_PuzzlesOfCody', ('content/img/text_PuzzlesOfCody.png') );
	  this.load.image('text_TheSuiteLifeOfZackAndCody', ('content/img/text_TheSuiteLifeOfZackAndCody.png') );
	  this.load.image('text_TheSuiteLifeOnDeck', ('content/img/text_TheSuiteLifeOnDeck.png') );
	  this.load.image('text_TheSuiteLifeMovie', ('content/img/text_TheSuiteLifeMovie.png') );
	  this.load.image('text_ToGameCommunity', ('content/img/text_ToGameCommunity.png') );
	  this.load.image('Window_640x480_opacity2', ('content/img/Window_640x480_opacity2.png') );
	  this.load.image('Window_800x529_opacity2', ('content/img/Window_800x529_opacity2.png') );
	  this.load.image('Window_303x194_opacity1', ('content/img/Window_303x194_opacity1.png') );
	  this.load.image('bnClose', ('content/img/bnClose.png') );
	  this.load.image('arrow_up', ('content/img/arrow_up.png') );
	  this.load.image('arrow_left', ('content/img/arrow_left.png') );
	  this.load.image('arrow_right', ('content/img/arrow_right.png') );
	  this.load.image('bnInfo', ('content/img/bnInfo.png') );
	  this.load.image('text_Info', ('content/img/text_Info.png') );
	  this.load.image('MesWin_WatchTheNewsInCommunity', ('content/img/MesWin_WatchTheNewsInCommunity.png') );
	  this.load.image('text_LevelComplete', ('content/img/text_LevelComplete.png') );
	  this.load.image('bnOk', ('content/img/bnOk.png') );
	  this.load.image('bnRestartLevel', ('content/img/bnRestartLevel.png') );
	  this.load.image('bnEasy', ('content/img/bnEasy.png') );
	  this.load.image('bnHard', ('content/img/bnHard.png') );
	  this.load.image('bnMinimize', ('content/img/bnMinimize.png') );
	  //
	  // Zack Puzzles
	  this.load.image('00_0', ('content/img/ZackPuzzles/SLOZAC/Zack_0.png') );
	  this.load.image('00_1', ('content/img/ZackPuzzles/SLOZAC/Zack_1.png') );
	  this.load.image('00_2', ('content/img/ZackPuzzles/SLOZAC/Zack_2.png') );
	  //
	  this.load.image('01_0', ('content/img/ZackPuzzles/SLOD/Zack_0.jpg') );
	  this.load.image('01_1', ('content/img/ZackPuzzles/SLOD/Zack_1.jpg') );
	  this.load.image('01_2', ('content/img/ZackPuzzles/SLOD/Zack_2.jpg') );
	  //
	  this.load.image('02_0', ('content/img/ZackPuzzles/SLM/Zack_0.jpg') );
	  this.load.image('02_1', ('content/img/ZackPuzzles/SLM/Zack_1.jpg') );
	  this.load.image('02_2', ('content/img/ZackPuzzles/SLM/Zack_2.jpg') );
	  //
	  // Cody Puzzles
	  this.load.image('10_0', ('content/img/CodyPuzzles/SLOZAC/Cody_0.png') );
	  this.load.image('10_1', ('content/img/CodyPuzzles/SLOZAC/Cody_1.png') );
	  this.load.image('10_2', ('content/img/CodyPuzzles/SLOZAC/Cody_2.png') );
	  //
	  this.load.image('11_0', ('content/img/CodyPuzzles/SLOD/Cody_0.jpg') );
	  this.load.image('11_1', ('content/img/CodyPuzzles/SLOD/Cody_1.jpg') );
	  this.load.image('11_2', ('content/img/CodyPuzzles/SLOD/Cody_2.jpg') );
	  //
	  this.load.image('12_0', ('content/img/CodyPuzzles/SLM/Cody_0.jpg') );
	  this.load.image('12_1', ('content/img/CodyPuzzles/SLM/Cody_1.jpg') );
	  this.load.image('12_2', ('content/img/CodyPuzzles/SLM/Cody_2.jpg') );
